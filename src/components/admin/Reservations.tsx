...
import { MOCK_RESERVATIONS, MOCK_RESIDENTS } from '../../mock';
import { Reservation } from '../../types';

// Interface local para datas bloqueadas (simulando estado persistente)
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar space-y-1 text-slate-600">
                    {dayReservations.map(r => (
                        <div key={r.id} className={`px-1 py-0.5 rounded text-[9px] font-medium truncate border ${
                            r.status === 'Confirmed' ? 'bg-green-50 text-green-700 border-green-100' :
