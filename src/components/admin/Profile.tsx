...
export const AdminProfile: React.FC = () => {
  const [profile, setProfile] = useState({
    ...
    registration: 'SP-12345/2023',
    department: 'Gestão Executiva',
    workHours: '08:00 - 18:00 (Seg a Sex)'
  });
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-[2.5rem] p-8 shadow-sm">
            <h4 className="text-xs font-black text-slate-400 uppercase tracking-[0.2em] mb-6 flex items-center gap-2">
              <Shield size={14} className="text-[#437476]" /> Segurança da Conta
            </h4>
            <div className="space-y-6">
               <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-black text-slate-700">Autenticação 2FA</p>
                      <p className="text-[10px] text-slate-400 font-bold uppercase">Ativado via App</p>
                    </div>
                  </div>
               ...
               <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                  <p className="text-[11px] text-slate-500 font-medium leading-relaxed">
                    Sua conta está protegida. O acesso exige confirmação via dispositivo móvel cadastrado.
                  </p>
               </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-[2.5rem] p-8 shadow-sm">
            <div className="flex items-center justify-between mb-8">
               <h3 className="text-xl font-black text-slate-800 tracking-tight flex items-center gap-3">
                 <Award size={24} className="text-[#437476]" /> Dados Profissionais
               </h3>
               <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">ID: 00982-A</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               ...
               <div className="space-y-6">
                  <div>
                    <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 ml-1">Registro Profissional / CRECI</label>
                    <div className="flex items-center gap-3 bg-slate-50 px-5 py-3.5 rounded-2xl border border-slate-100">
                      <PenTool size={18} className="text-slate-400" />
                      <span className="text-sm font-black text-[#437476]">{profile.registration}</span>
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="flex items-center gap-3 bg-slate-50 px-5 py-3.5 rounded-2xl border border-slate-100">
                      ...
                      <span className="text-sm font-bold text-slate-700">{profile.workHours}</span>
                    </div>
                  </div>
                  <div className="pt-4">
                     <button className="text-[10px] font-black text-[#437476] uppercase tracking-widest hover:underline flex items-center gap-2">
                        Configurar Assinatura Digital <ChevronRight size={12} />
                     </button>
                  </div>
               </div>
            </div>
              ...
              <div className="px-10 py-10">
                 ...
                 <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                       ...
                       <div className="space-y-1.5">
                          <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Cargo</label>
                          <input 
                            type="text" 
                            className="w-full px-5 py-3.5 bg-white border border-slate-200 rounded-2xl text-sm font-bold text-slate-700 outline-none focus:ring-4 focus:ring-[#437476]/5 focus:border-[#437476] transition-all" 
                            value={profile.role}
                    ...
                    <div className="space-y-1.5">
                       ...
                       >
                          <option>Gestão Executiva</option>
