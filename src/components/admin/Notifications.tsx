                                ...
                                MOCK_INFRACTIONS.map(inf => (
                                    <tr key={inf.id} className="hover:bg-slate-50 transition-colors bg-[#fcfbf9]">
                                        ...
                                        <td className="px-6 py-4">
                                            <span className={`flex items-center gap-1.5 w-fit px-2.5 py-1 rounded-md text-xs font-bold uppercase tracking-wide ${inf.type === 'MULTA' ? 'bg-red-50 text-red-700 border border-red-100' : 'bg-amber-50 text-amber-700 border border-amber-100'
                                                }`}>
                                                {inf.type === 'MULTA' ? 'Multa' : 'Notificação'}
                                            </span>
                                        </td>
                                        ...
                                        <td className="px-6 py-4">
                                            <span className="px-2 py-1 bg-slate-100 rounded text-xs text-slate-600 border border-slate-200 font-medium">
                                                {inf.status === 'ABERTO' ? 'Em Aberto' : inf.status}
                                            </span>
                                        </td>
